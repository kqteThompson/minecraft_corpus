...
predicted_relations = 'bert_linear_preds.json'
...
save_path= current_folder + '/glozz_linear_pred/'
...
for game in preds:
    ...
    with open (save_path + '/' + dialogue_id + '_linpred.aa', 'w') as xml_file:
        xml_file.write(aa_file)
    with open (save_path + '/' + dialogue_id + '_linpred.ac', 'w') as text_file:
